...
if ($referrer=="i") {
	echo '<META HTTP-EQUIV="Refresh" CONTENT="10; url=listItems.php?type='.$type.'&contextId='.$contextId.'&timeId='.$timeId.'">';
	}

elseif ($referrer=="p") {
	echo '<META HTTP-EQUIV="Refresh" CONTENT="10; url=projectReport.php?projectId='.$projectId.'">';
	}
