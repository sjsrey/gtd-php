...
$sql = array(
        ...
        "copynextaction"            => "INSERT INTO `nextactions` (`projectId`,`nextaction`) VALUES ('{$values['projectId']}','{$values['newitemId']}') ON DUPLICATE KEY UPDATE `nextaction`='{$values['newitemId']}'",
        ...
        "newitemattributes"         => "INSERT INTO `itemattributes` (`itemId`,`type`,`projectId`,`contextId`,`timeframeId`,`deadline`,`repeat`,`suppress`,`suppressUntil`) VALUES ('{$values['newitemId']}','{$values['type']}','{$values['projectId']}','{$values['contextId']}','{$values['timeframeId']}','{$values['deadline']}','{$values['repeat']}','{$values['suppress']}','{$values['suppressUntil']}')",
        ...
        "removenextactions"          => "DELETE FROM `nextactions` WHERE `projectId`='{$values['projectId']}'",
